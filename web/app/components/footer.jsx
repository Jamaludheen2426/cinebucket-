export default function Footer() {
    return (
        <footer className="bg-[#0d0f11]">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <img src="/group_118.svg" className="h-8 me-3" alt="CineBucket Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap text-gray-400">CineBucket</span>
                        </a>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-400 sm:text-center">© 2024 <a href="/" className="hover:text-white">CineBucket™</a>. All Rights Reserved.
                    </span>
